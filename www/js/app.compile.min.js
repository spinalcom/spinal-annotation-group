...
(function(e){"use strict";var t=function(){function defineProperties(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(e,t,n){return t&&defineProperties(e.prototype,t),n&&defineProperties(e,n),e}}();function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}angular.module("app.spinalforge.plugin").run(["spinalModelDictionary","$mdDialog","$mdToast","authService","$rootScope","$compile",function(e,n,i,a,l,o){var s=function(){function PannelAnnotation(e,t){var n=this;_classCallCheck(this,PannelAnnotation),Autodesk.Viewing.Extension.call(this,e,t),this.viewer=e,this.panel=null,this.user=a.get_user(),this.messagePanel,this.filePanel,l.exec_function=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;switch(e){case"createTheme":n.createTheme();break;case"addNote":n.createNote(t);break;case"seeAnnotation":n.SeeAnnotation(t);break;case"addItem":n.AddItems(t,i);break;case"changeColor":n.changeColorInHub(t,i,a);break;case"view":n.viewOrHide(t,i);break;case"rename":n.renameNote(t,i);break;case"delete":n.deleteNoteItem(t,i,a);break;case"info":n.viewMessagePanel(t,i);break;case"file":n.viewFilePanel(t,i);break;case"seeAll":n.viewOrHideAllItem(t);break;case"select_annotation":n.SelectAnnotation(t)}}}return t(PannelAnnotation,[{key:"load",value:function(){return this.viewer.toolbar?this.createUI():(this.onToolbarCreatedBinded=this.onToolbarCreated.bind(this),this.viewer.addEventListener(av.TOOLBAR_CREATED_EVENT,this.onToolbarCreatedBinded)),!0}},{key:"onToolbarCreated",value:function(){this.viewer.removeEventListener(av.TOOLBAR_CREATED_EVENT,this.onToolbarCreatedBinded),this.onToolbarCreatedBinded=null,this.createUI()}},{key:"unload",value:function(){return this.viewer.toolbar.removeControl(this.subToolbar),!0}},{key:"createUI",value:function(){var e=this;this.panel=new PanelClass(this.viewer,"Annotation"),this.initialize();var t=new Autodesk.Viewing.UI.Button("Annotation");t.onClick=function(t){e.panel.isVisible()?e.panel.setVisible(!1):e.panel.setVisible(!0)},t.addClass("fa"),t.addClass("fa-pencil"),t.addClass("fa-2x"),t.setToolTip("Annotation"),this.subToolbar=new Autodesk.Viewing.UI.ControlGroup("my-Annotation"),this.subToolbar.addControl(t),this.viewer.toolbar.addControl(this.subToolbar)}},{key:"initialize",value:function(){var t=this;this.panel.initializeMoveHandlers(this.panel.container);var n=angular.element(this.panel.container);e.init().then(function(e){e&&(e.groupAnnotationPlugin?e.groupAnnotationPlugin.load(function(e){t.model=e,t.func_success(t.model,n)}):(t.model=new Lst,e.add_attr({groupAnnotationPlugin:new Ptr(t.model)}),t.func_success(t.model,n)))})}},{key:"func_success",value:function(e,t){var n=this;this.messagePanel=new MessagePanel(this.viewer,this.model,this.user),this.filePanel=new FilesPanel(this.viewer,this.model,this.user);var i=angular.element('<div class="_container"></div>'),a=angular.element('<md-button class="md-raised md-primary block" ng-click="exec_function(\'createTheme\')">Create a group</md-button>'),s=document.createElement("div");s.className="themes",i.append(a),e.bind(function(){s.innerHTML="",n.displayTheme(s,i,e)}),o(i)(l),t.append(i)}},{key:"displayAnnotation",value:function(e){for(var t,n=this.model,i="<md-list class='md-list-item-text' id=\"a_"+e+'">',a=0;a<n.length;a++){var l=n[a];if(l.id==e){t=l;break}}if(null!=t)for(var o=0;o<t.listModel.length;o++){var s=t.listModel[o];i+='<md-list-item class="noright _annotation" id="an_'+s.id.get()+'">\n                <p class="noteTitle" ng-click="exec_function(\'select_annotation\',\''+s.id.get()+"')\">"+s.title.get()+'</p>\n\n                <md-button class="i_btn" aria-label="add_item" id='+s.id.get()+" ng-click=\"exec_function('addItem','"+t.id.get()+"','"+s.id.get()+'\')">\n                  <i class="fa fa-plus" aria-hidden="true"></i>\n                </md-button>\n\n                <input class="i_btn input_color" value="'+s.color.get()+"\" id=\"i_color\" type='color' theme='"+t.id.get()+"' name='"+s.id.get()+"' ng-click=\"exec_function('select_annotation','"+s.id.get()+'\')"/>\n\n                <md-button class="i_btn show'+s.id.get()+"\" id='e_"+s.id.get()+"' aria-label=\"view\" ng-click=\"exec_function('view','"+t.id.get()+"','"+s.id.get()+'\')" show="false">\n                  <i class="fa fa-eye" aria-hidden="true"></i>\n                </md-button>\n\n                <md-button class="i_btn" id='+s.id.get()+" aria-label=\"rename\" ng-click=\"exec_function('rename','"+t.id.get()+"','"+s.id.get()+'\')">\n                  <i class="fa fa-pencil" aria-hidden="true"></i>\n                </md-button>\n\n                <md-button class="i_btn" id='+s.id.get()+" aria-label=\"delete\" ng-click=\"exec_function('delete','"+t.id.get()+"','"+s.id.get()+'\')">\n                  <i class="fa fa-trash" aria-hidden="true"></i>\n                </md-button>\n\n                <md-button class="i_btn" id='+s.id.get()+" aria-label=\"info\" ng-click=\"exec_function('info','"+t.id.get()+"','"+s.id.get()+'\')">\n                  <i class="fa fa-comment" aria-hidden="true"></i>\n                </md-button>\n\n                <md-button class="i_btn" id='+s.id.get()+" aria-label=\"info\" ng-click=\"exec_function('file','"+t.id.get()+"','"+s.id.get()+'\')">\n                  <i class="fa fa-paperclip" aria-hidden="true"></i>\n                </md-button> \n\n            </md-list-item>'}return i+="</md-list>"}},{key:"displayTheme",value:function(e,t,n){var i,a,s=angular.element("<md-list></md-list>");if(n.length>0)for(var r=0;r<n.length;r++)a=n[r],i=angular.element('\n              <md-list-item class="" id="l_'+a.id.get()+"\">   \n                <p id='p_"+a.id.get()+"' show=\"false\" ng-click=\"exec_function('seeAnnotation','"+a.id.get()+'\')">\n                  <i class="fa fa-caret-right"></i>\n                  &nbsp;\n                  '+a.name.get()+'\n                </p>\n\n                <md-button class="i_btn" aria-label="add_item" id='+a.id.get()+" ng-click=\"exec_function('addNote','"+a.id.get()+'\')">\n                  <i class="fa fa-plus" aria-hidden="true"></i>\n                </md-button>\n\n                <md-button class="i_btn show'+a.id.get()+"\" id='th_"+a.id.get()+'\' aria-label="view" show="false" ng-click="exec_function(\'seeAll\',\''+a.id.get()+'\')">\n                  <i class="fa fa-eye" aria-hidden="true"></i>\n                </md-button>\n\n                <md-button class="i_btn" id='+a.id.get()+" aria-label=\"rename\" ng-click=\"exec_function('rename','"+a.id.get()+'\')">\n                  <i class="fa fa-pencil" aria-hidden="true"></i>\n                </md-button>\n\n                <md-button class="i_btn" id='+a.id.get()+" aria-label=\"delete\" ng-click=\"exec_function('delete','"+a.id.get()+'\')">\n                  <i class="fa fa-trash" aria-hidden="true"></i>\n                </md-button>\n\n              </md-list-item>\n\n              '+this.displayAnnotation(a.id.get())+"\n            "),s.append(i);else s.append("<h1>No note created ! create one</h1>");var d=angular.element(e),c=angular.element(s);d.append(c),o(c)(l),t.append(d);var u=document.getElementsByClassName("input_color");console.log("colors",u);for(var h=this,f=0;f<u.length;f++)u[f].onchange=function(){h.changeColorInHub(this.getAttribute("theme"),this.name,this.value)}}},{key:"createTheme",value:function(){var e=this,t=this.model,i=new ThemeModel;i.id.set(newGUID()),i.creation.set(Date.now()),i.owner.set(this.user.id),i.username.set(this.user.username);var a=n.prompt().title("Theme").placeholder("Please enter the theme").ariaLabel("New Theme").clickOutsideToClose(!0).required(!0).ok("create!").cancel("Cancel");n.show(a).then(function(n){i.name.set(n),t.push(i),console.log(e.model)},function(){})}},{key:"createNote",value:function(e){var t,i=this.model;this.SeeAnnotation(e,"item");for(var a=0;a<i.length;a++){var l=i[a];if(l.id==e){t=l;break}}var o=new NoteModel;o.id.set(newGUID()),o.owner.set(this.user.id),o.username.set(this.user.username),o.date.set(Date.now()),o.color.set("#000000");var s=n.prompt().title("Note").placeholder("Note name").ariaLabel("New Note").clickOutsideToClose(!0).required(!0).ok("create").cancel("Cancel");n.show(s).then(function(e){o.title.set(e),t.listModel.push(o)},function(){})}},{key:"HideAnnotation",value:function(e,t,n,i){t.style.display="none",n.setAttribute("show","false"),i.setAttribute("class","fa fa-caret-right"),document.getElementById("l_"+e).className=""}},{key:"SeeAnnotation",value:function(e){for(var t,n,i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,a=this.model,l=0;l<a.length;l++){n=(t=a[l]).id;var o=document.getElementById("p_"+n),s=document.getElementById("a_"+n),r=o.getElementsByTagName("i")[0];t.id==e?"false"==o.getAttribute("show")?(s.style.display="block",o.setAttribute("show","true"),r.setAttribute("class","fa fa-caret-down"),document.getElementById("l_"+n).className="select"):null==i&&this.HideAnnotation(n,s,o,r):this.HideAnnotation(n,s,o,r)}}},{key:"viewOrHideAllItem",value:function(e){var t=document.getElementById("th_"+e);"false"==t.getAttribute("show")?(t.innerHTML='<i class="fa fa-eye-slash"></i>',t.setAttribute("show","true"),this.changeAllItemsColor(e),this.changeAllAnnotationIcon(e,"false")):(t.innerHTML='<i class="fa fa-eye"></i>',t.setAttribute("show","false"),this.restoreAllItemsColor(e),this.changeAllAnnotationIcon(e,"true"))}},{key:"getAllAnnotationId",value:function(e){this.SeeAnnotation(e,"item");for(var t,n=[],i=this.model,a=0;a<i.length;a++)if(i[a].id==e){t=i[a];for(a=0;a<t.listModel.length;a++){for(var l,o=[],s=0;s<t.listModel[a].allObject.length;s++)o.push(t.listModel[a].allObject[s].dbId.get());l=t.listModel[a].color.get(),n.push({ids:o,color:l,id:t.listModel[a].id})}return n}}},{key:"changeAllItemsColor",value:function(e){var t=this.getAllAnnotationId(e);this.viewer.colorAllMaterials(t)}},{key:"restoreAllItemsColor",value:function(e){var t=this.getAllAnnotationId(e);this.viewer.restoreAllMaterialColor(t)}},{key:"changeAllAnnotationIcon",value:function(e,t){for(var n=this.model,i=0;i<n.length;i++){var a=n[i];if(a.id==e)for(var l=0;l<a.listModel.length;l++){var o=a.listModel[l],s=document.getElementById("e_"+o.id.get());"false"==t?(s.innerHTML='<i class="fa fa-eye-slash"></i>',s.setAttribute("show","true")):(s.innerHTML='<i class="fa fa-eye"></i>',s.setAttribute("show","false"))}}}},{key:"verifyIcon",value:function(e){for(var t=this.model,n=!0,i=0;i<t.length;i++){var a=t[i];if(a.id==e){for(var l=0;l<a.listModel.length;l++){var o=a.listModel[l];if("false"==document.getElementById("e_"+o.id).getAttribute("show")){n=!1;break}}return n}}}},{key:"SelectAnnotation",value:function(e){for(var t=document.getElementsByClassName("_annotation"),n=0;n<t.length;n++){var i=t[n];i.getAttribute("id")=="an_"+e?i.classList.add("an_select"):i.classList.remove("an_select")}}},{key:"AddItems",value:function(e,t){var n,a,l,o=this.viewer.getSelection(),s=this.model;this.SelectAnnotation(t),0!=o.length?this.viewer.model.getBulkProperties(o,{propFilter:["name"]},function(o){for(var r=0;r<s.length;r++)if(s[r].id==e){a=r;for(var d=0;d<s[r].listModel.length;d++){if(s[r].listModel[d].id==t){l=d,n=s[r].listModel[d].allObject;break}}break}for(var c=0;c<o.length;c++)n.push(o[c]);s[a].listModel[l].allObject=n;var u=i.simple().content("Item added !").action("OK").highlightAction(!0).hideDelay(0).position("bottom right").parent("body");i.show(u)},function(){console.log("error")}):alert("No model selected !")}},{key:"changeColorInHub",value:function(e,t,n){console.log("themeId",e),console.log("annotationId",t),console.log("color",n);for(var i=this.model,a=0;a<i.length;a++)if(i[a].id==e){for(var l=0;l<i[a].listModel.length;l++){if(i[a].listModel[l].id==t){i[a].listModel[l].color.set(n);break}}break}}},{key:"getItemsId",value:function(e,t){for(var n,i=[],a=this.model,l=0;l<a.length;l++)if(a[l].id==e){for(var o=0;o<a[l].listModel.length;o++){if(a[l].listModel[o].id==t){n=a[l].listModel[o];break}}break}for(var s=0;s<n.allObject.length;s++)i.push(n.allObject[s].dbId.get());return{ids:i,selected:n}}},{key:"changeItemColor",value:function(e,t){var n=this.getItemsId(e,t);this.viewer.setColorMaterial(n.ids,n.selected.color.get(),n.selected.id.get());var i=document.getElementById("th_"+e);this.verifyIcon(e)?(i.setAttribute("show","true"),i.innerHTML='<i class="fa fa-eye-slash"></i>'):(i.setAttribute("show","false"),i.innerHTML='<i class="fa fa-eye"></i>'),this.SelectAnnotation(t)}},{key:"restoreColor",value:function(e,t){var n=this.getItemsId(e,t);this.viewer.restoreColorMaterial(n.ids,n.selected.id);var i=document.getElementById("th_"+e);this.verifyIcon(e)?(i.setAttribute("show","true"),i.innerHTML='<i class="fa fa-eye-slash"></i>'):(i.setAttribute("show","false"),i.innerHTML='<i class="fa fa-eye"></i>'),this.SelectAnnotation(t)}},{key:"deleteNoteItem",value:function(e,t,i){var a=this.model;null==i&&null!=t?this.SelectAnnotation(t):null==t&&this.SeeAnnotation(e,"item");var l=n.confirm().ok("Delete !").title("Do you want to remove it?").cancel("Cancel").clickOutsideToClose(!0);n.show(l).then(function(n){for(var l,o,s=0;s<a.length;s++)if(a[s].id==e){l=s;for(var r=0;r<a[s].listModel.length;r++)if(a[s].listModel[r].id==t){o=r;break}break}if(null!=i)for(var d=0;d<a[l].listModel[o].allObject.length;d++){if(a[l].listModel[o].allObject[d].dbId==i){a[l].listModel[o].allObject.splice(d,1);break}}else null==i&&null!=t?a[l].listModel.splice(o,1):a.splice(l,1)},function(){})}},{key:"renameNote",value:function(e,t){var i=this.model;null!=t?this.SelectAnnotation(t):this.SeeAnnotation(e,"theme");var a=n.prompt().title("Rename Note").placeholder("Please enter the title").ariaLabel("Rename").clickOutsideToClose(!0).required(!0).ok("Rename").cancel("Cancel");n.show(a).then(function(n){for(var a,l=0;l<i.length;l++)if(i[l].id==e){a=l;break}if(null!=t)for(var o=0;o<i[a].listModel.length;o++){if(i[a].listModel[o].id==t){i[a].listModel[o].title.set(n);break}}else i[a].name.set(n)},function(){})}},{key:"viewOrHide",value:function(e,t){var n=document.getElementsByClassName("show"+t)[0];"false"==n.getAttribute("show")?(n.setAttribute("show","true"),this.changeItemColor(e,t),n.innerHTML='<i class="fa fa-eye-slash" aria-hidden="true"></i>'):(n.setAttribute("show","false"),this.restoreColor(e,t),n.innerHTML='<i class="fa fa-eye" aria-hidden="true"></i>')}},{key:"viewMessagePanel",value:function(e,t){this.SelectAnnotation(t),this.messagePanel.DetailPanel(e,t)}},{key:"viewFilePanel",value:function(e,t){this.SelectAnnotation(t),this.filePanel.DisplayFilePanel(e,t)}}]),PannelAnnotation}();Autodesk.Viewing.theExtensionManager.registerExtension("PannelAnnotation",s)}]),e._createClass=t,e._classCallCheck=_classCallCheck}).call(window,window);
...
},{}]},{},[2,1,3,8,14,15,13,12,6,7,4,5,10,9,11])
